...
import com.yingbu.nettools.securitynettransfer.thread.ServerThread;
import com.yingbu.nettools.securitynettransfer.util.Config;
...
public class Server extends Thread {
    ...
    public Server(String proxyHost, int proxyPort, String listenPort, String password) {
        ...
        log("proxyHost:"+proxyHost+" proxyPort:"+proxyPort+" listenPort:"+listenPort);
    }
    ...
    public void run() {
        ...
        while (!kill) {
            ...
            ThreadPool.currentThreadPool().submitClientThread(serverThread);
        }
        kill = true;
        if (serverSocket != null && !serverSocket.isClosed()) {
            try {
