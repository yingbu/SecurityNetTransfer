 ...
 *
 */
public class EncryptForwardThread implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                if (read_num == -1) {
                    log("EncryptForwardThread break.");
                ...
                if (encrypt_bytes == null) {
                    log("EncryptForwardThread error break.");
                    break; // 加密出错，退出
        ...
        parent.over();
        log("EncryptForwardThread closed");
